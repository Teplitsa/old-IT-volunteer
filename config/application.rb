...
module Volunteer
  class Application < Rails::Application
    ...
    # FIXME: find why defult_locale != locale on staging
    ...
    config.generators do |generator|
      ...
      generator.stylesheets false #disable automated generation of scaffold.css.scss. May affect other generators
